...
pretrained_settings = {
    'bninception': {
        'imagenet': {
            ...
            'path':'/home/zhujian/.torch/models/bn_inception-9f5701afb96c8044.pth',
            'input_space': 'BGR',
            'input_size': 224,
            'input_range': [0, 255],
            'mean': [104, 117, 128],
...
class BNInception(nn.Module):
    ...
    def _build_features(self, inplace, num_classes):
        self.conv1_7x7_s2 = nn.Conv2d(self.inp, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3))
    ...
    def load_state_dict(self, state_dict, strict=True):
        ...
        super(BNInception, self).load_state_dict(md, False)

def bninception(inp=3,pretrained='imagenet'):
    ...
    if pretrained is not None:
        ...
        model = BNInception(inp=inp,num_classes=num_classes)
...
if __name__ == '__main__':
    model = bninception(inp=3)
    a = torch.rand(1,3,8,224,224)
    print(model.state_dict()['conv1_7x7_s2.weight'][0,0])
    # b = model(a)
    # print(b.shape)