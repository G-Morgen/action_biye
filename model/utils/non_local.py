...
if __name__ == '__main__':
    ...
    # net = NONLocalBlock1D(100, sub_sample=sub_sample, bn_layer=bn_layer, inter_channels=50)
    # out = net(img)
    ...
    # net = NONLocalBlock2D(100, sub_sample=sub_sample, bn_layer=bn_layer, inter_channels=50)
    # out = net(img)
    # flops, params = profile(net, inputs=(img,), verbose=False)
    # print(flops / 1e9, params / 1e6)
    # print(out.size())
    ...
    net = NONLocalBlock3D(100, sub_sample=sub_sample, bn_layer=bn_layer, inter_channels=50)
    out = net(img)
    flops, params = profile(net, inputs=(img,), verbose=False)
    print(flops / 1e9, params / 1e6)
    print(out.size())        