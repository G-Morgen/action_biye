...
class UCF101Dataset(Dataset):
    ...
    def __init__(self,mode='valid',modality='rgb',split=0,frame_counts=10,step_size=2,sample_times=1,sample='sparse',transform=None):
...
if __name__ == "__main__":
    ...
    frames = 8
    a, _ = make_data(frames,4,'flow','bn_inception',sample='dense')
    t = time.time()
